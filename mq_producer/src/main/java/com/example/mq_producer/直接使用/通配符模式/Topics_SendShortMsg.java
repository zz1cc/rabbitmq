...
public class Topics_SendShortMsg {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //绑定队列到交换机(两个绑定规则，即使同时满足，也不会发送两次消息)
        channel.queueBind(QUEUE_MESSAGE, EXCHANGE_NAME, "*.*.message");
        channel.queueBind(QUEUE_MESSAGE, EXCHANGE_NAME, "rabbit.#");
        //队列消费者
